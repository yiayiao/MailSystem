...
<script type="text/javascript">
	function Form_Submit() {
		if (regConfig.logname.value == "") {
			...
			alert("密码不能为空!");
			return false;
		} else if (regConfig.password.value != regConfig.rpassword.value) {
			alert("两次输入的密码不一致!");
			return false;
		}
		return true;
...
<body>
	<div id="register">
		<p class="tis">请输入您的信息，注意带*的必填</p>
		<form action="HandleRegister" method="post" id="regConfig"
			name="regConfig" onsubmit="return Form_Submit();">
			<ul>
				...
				<li>确认： <input type="password" id="rpassword" name="rpassword" />*
					<span id="rpassword_help" class="help"></span>
				</li>
				<li>性别： <input type="radio" name="gender" checked="checked"
					value="male">男 <input type="radio" name="gender"
					value="female">女
				</li>
				<li>邮箱： <input type="text" id="email" name="email" />* <span
					id="email_help" class="help"></span>
				</li>
				<li>电话： <input type="text" id="phone" name="phone" />* <span
					id="phone_help" class="help"></span>
				</li>
				<li>您的个人简介：</li>
				<li><TextArea name="message" rows="6" cols="50"></TextArea></li>
			</ul>
			<table>
				<tr>
